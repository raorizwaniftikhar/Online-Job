...
<tr>
<td width="100%" align="center" valign="top"><img src="images/header_bg.jpg" alt="rana here" width="964" height="170"  border="0" /></td>
</tr>
  <tr>
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td align="left" valign="top"><table width="573" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" valign="middle" bgcolor="#3997DD" style="font-size:10px; color:#FFF;">Searched jobs </td>
                </tr>
              <tr>
                <td align="left" valign="top">&nbsp;</td>
              </tr>
...
$sql1="select * from posted_job where jobtitle Like'%$_POST[search]%'";
