        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td align="left" valign="top"><table width="573" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" valign="middle" bgcolor="#3997DD" style="font-size:10px; color:#FFF;">Applicant Detail </td>
                </tr>
              <tr>
                <td align="left" valign="top">&nbsp;</td>
              </tr>
...
$id=$_REQUEST['id'];
$sql="select * from education where nic_no=$id";
$result=mysql_query($sql);


echo "<table width='50%'  border='0' bgcolor='#FFFFFF' align='center'>";
	echo "<tr  bgcolor='#6699FF'>
             <td colspan='8'><div align='center'><strong>Applicant Education </strong></div></td>
              </tr>";
...
$sql="select * from Experience where nic_no=$id";
$result=mysql_query($sql);
	echo "<tr  bgcolor='#6699FF'>
             <td colspan='8'><div align='center'><strong>Applicant Experience </strong></div></td>
              </tr>";
...
$post=$row['post'];
$salary=$row['salary'];
$sd=$row['starting_date'];
$ed=$row['ending_date'];
$reason=$row['reson_flj'];
